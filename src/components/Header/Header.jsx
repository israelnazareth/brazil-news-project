...
export default function Header() {
  ...
  const getNewsByCategory = async (category = 'general', type = 'Geral') => {
    ...
    setArticles({ articles: articlesAPI, type })
  }
    ...
    <div className="header">
      <div className="headerContent">
        ...
        <ul className="listNavbar">
          ...
          <li className="itemNavbar" onClick={() => getNewsByCategory('world', 'Mundo') && showCategories()}>Mundo</li>
          <li className="itemNavbar" onClick={() => getNewsByCategory('nation', 'Brasil') && showCategories()}>Brasil</li>
          ...
          <li className="itemNavbar" onClick={() => getNewsByCategory('sports', 'Esportes') && showCategories()}>Esporte</li>
